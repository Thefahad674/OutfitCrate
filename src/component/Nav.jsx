  ...
  return (
    <div className='w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black'>
        ...
        <div className='w-[30%] flex items-center justify-start gap-[10px] '>
           ...
           <h1 className='text-[25px] text-black font-sans'>OutfitCrate</h1>
        </div>
        <div className='w-[40%]'>
       ...
       { !showSearch ? <IoSearchCircleOutline className='w-[38px] h-[38px] text-[#000000] cursor-pointer' onClick={()=>setShowSearch(!showSearch)}/> : <IoSearchCircle className='w-[35px] h-[35px] text-[#000000] cursor-pointer' onClick={()=>setShowSearch(!showSearch)} />}


        {!userData && <FaUserCircle className='w-[30px] h-[30px] text-[#000000] cursor-pointer' onClick={()=>setShowProfile(!showProfile)} />}
       { userData && <div className='w-[30px] h-[30px] bg-[#080808] text-white rounded-full flex items-center justify-center'>{userData?.name.slice(0,1)}</div>}
        <IoCartOutline className='w-[30px] h-[30px] text-[#000000] cursor-pointer' />
       ...
       { showSearch && <div className='w-[100%] h-[80px] bg-[#d8f6f9dd] absolute top-[100%] left-0 right-0 flex items-center justify-center'>
        ...
        { showProfile && <div className='absolute w-[220px] h-[150px] bg-[#000000d7] top-[110%] right-[4%] border-[1px] border-[#aaa9a9] rounded-[10px] z-10'>
            <ul className='w-[100%] h-[100%] items-start justify-around flex-col text-[17px] py-[10px] text-white'>
